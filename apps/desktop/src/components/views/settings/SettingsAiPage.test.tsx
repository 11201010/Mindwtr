...
const t = {
    ...
    aiUsageBreakdown: 'Break down: in that same sparkle menu, choose Break down to split a task or project into concrete steps.',
    aiUsageSuggestions: 'Suggestions: as you type a task title or notes, an AI suggestion for context, time estimate, and tags appears below — click it to apply.',
