...
val LABEL_KEYS = listOf(
    ...
    "taskEdit.suppressMindwtrReminders", "taskEdit.suppressMindwtrRemindersHint", "taskEdit.repeatReminderLabel",
    "taskEdit.repeatReminderEveryMinutes", "taskEdit.startModeRelative", "taskEdit.relativeStartBeforeDue",
    "taskEdit.relativeStartMinutesShort", "taskEdit.relativeStartHoursShort", "taskEdit.relativeStartDaysShort",
    "taskEdit.relativeStartWeeksShort", "viewSections.somedaySection", "taskEdit.checklist", "taskEdit.tab.list", "attachments.title",
