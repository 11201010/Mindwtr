...
const addProjectSchema = z.object({
  ...
  cancelledAt: z.string().datetime({ offset: true }).nullable().optional().describe('Cancellation time; closes the project and its unfinished tasks while preserving completed work'),
