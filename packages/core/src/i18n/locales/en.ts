...
export const en: Record<string, string> = {
    ...
    'sandbox.switchFailed': "Could not switch workspaces. Your current workspace is unchanged.",
        ...
        'keybindings.focusSidebar': 'Move focus one panel left',
        'keybindings.focusContent': 'Move focus one panel right',
        ...
        'keybindings.list.copyTitle': 'Copy selected task title',
        'keybindings.list.copyWithDescription': 'Copy selected task title and description',
        ...
        'list.taskCopied': 'Task copied to clipboard',
        'list.taskCopyFailed': 'Could not copy task',
        ...
        'task.skipOccurrenceSaveFirst': 'Save or discard status and recurrence changes before skipping.',
        ...
        'taskEdit.unsavedChanges': 'Unsaved changes',
        'taskEdit.saveOrDiscardChanges': 'Save your changes before leaving?',
  ...
  'projects.reorderNeedsDefaultSort': 'Available when Sort is Default',
        ...
        'dailyReview.completeDesc': 'You’re clear and ready to engage. Finishing the guide does not mark individual reminders reviewed.',
        ...
        'review.completeDesc': 'You\'ve clarified your inputs, updated your lists, and you\'re ready to engage with your work. Finishing the guide does not mark individual reminders reviewed.',
        ...
        'review.dueHelp': 'Review reminders due now. Tasks without a review date stay in the overview.',
        'review.overviewHelp': 'Browse open tasks across your system.',
        'review.dueEmpty': 'No review reminders are due.',
        'review.overviewEmpty': 'No open tasks to review.',
        ...
        'process.twoMin': 'Will it take less than 2 minutes?',
  ...
  'settings.syncPreferenceGtd': 'GTD settings and defaults',
        ...
        'ai.appleClarification.stale': 'The item or its available associations changed. Ask for a fresh suggestion.',
        'ai.appleClarification.suggestionTitle': 'On-device suggestion',
        'settings.appleClarification.title': 'Inbox clarification',
        'settings.appleClarification.prototypeHint': 'Development prototype. This choice is stored only on this device.',
        'settings.appleClarification.configured': 'Configured provider',
        'settings.appleClarification.onDevice': 'On-device',
        ...
        'settings.feedbackEmailPlaceholder': 'Email for replies and follow-up',
        'settings.feedbackIncludeDiagnostics': 'Include recent diagnostics',
        'settings.feedbackIncludeDiagnosticsDesc': 'Recent activity and errors. Reproduce the issue on this device before sending.',
    ...
    'obsidian.bringIntoMindwtrFailed': 'Could not add the task to Mindwtr.',
        ...
        'settings.fontFamilyDesc': 'Choose a font installed on this computer.',
        'settings.fontFamilyDefault': 'App default',
        'settings.fontFamilyPlaceholder': 'Font name, for example Inter',
        ...
        'settings.undoNotificationsDesc': 'Show an Undo action after completing, deleting, or cancelling tasks.',
        ...
        'settings.taskEditorPresentationInline': 'In-row',
        'settings.taskEditorPresentationInlineDesc': 'Replace the task row with the editor in the current list.',
        ...
        'settings.aiUsageBreakdown': 'Break down: in that same sparkle menu, choose Break down to split a task or project into concrete steps.',
        'settings.aiUsageSuggestions': 'Suggestions: as you type a task title or notes, an AI suggestion for context, time estimate, and tags appears below — click it to apply.',
        ...
        'settings.calendarIntegrationGuideTitle': 'Calendar integration guide',
        'settings.calendarIntegrationGuideDesc': 'Setup notes for device calendars, push-to-calendar, and ICS subscriptions.',
        'settings.obsidianIntegrationGuideTitle': 'Obsidian integration guide',
        'settings.emailCaptureGuideTitle': 'Email capture guide',
