...
<div align="center">
  <video src="https://github.com/user-attachments/assets/50661fd1-fb1c-4b50-96a0-2712b05f313d" controls playsinline width="900" aria-label="试试 Mindwtr — 0:55"></video>
  <p><b>试试 Mindwtr — 0:55</b></p>
...
<p align="center">
  <video src="https://github.com/user-attachments/assets/76fa11bc-574b-49f5-a703-b2523dac91fa" controls playsinline width="900" aria-label="用 Mindwtr 实践 GTD — 2:41"></video>
  <br>
  <b>用 Mindwtr 实践 GTD — 2:41</b>
</p>
...
<p align="center">
  <a href="https://docs.mindwtr.app/assets/diagrams/gtd-workflow"><img src="https://docs.mindwtr.app/assets/diagrams/gtd-workflow.svg" alt="Mindwtr 的 GTD 循环：收集到收件箱、澄清、整理进项目和清单、每周回顾、在专注视图中执行" width="900"></a>
  <br>
  <sub>整个循环，一页看完。<a href="https://docs.mindwtr.app/assets/diagrams/gtd-workflow">打开交互式图表</a></sub>
</p>
...
Mindwtr 默认简单，需要时足够强大，生活一团糟时也不苛责你：

- 高级选项在需要时才出现。
- 更少字段、更少按钮、更少干扰。
- 清爽胜过堆料，坚决不做功能膨胀。
- 两周没打开，回来看到的是一个能下手的下一步，而不是一堆内疚。没有连续打卡，没有效率评分。
...
- 📊 **时间线** - 带日期的任务和项目按开始到截止日期绘制成色条，按项目着色，支持日/周/月缩放（桌面端，可选）
- 📋 **看板** - 看板式拖拽
- 📝 **回顾** - 每日 + 每周回顾流程
- 📦 **归档** - 隐藏历史，按需搜索
